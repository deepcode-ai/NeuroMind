...
class BaseWrapper(object):
    """
    Base class for the Neuromind scikit-learn wrapper.
...
class NeuromindClassifier(BaseWrapper):
    """
    Implementation of the scikit-learn classifier API for Neuromind.

    Parameters
    ----------
    model : object
        An un-compiled Neuromind model object is required to use the scikit-learn wrapper.
    optimizer : string
    ...
    def __init__(self, model, optimizer='adam', loss='categorical_crossentropy', **kwargs):
        super(NeuromindClassifier, self).__init__(model, optimizer, loss, **kwargs)
...
class NeuromindRegressor(BaseWrapper):
    """
    Implementation of the scikit-learn regressor API for Neuromind.
    ...
    def __init__(self, model, optimizer='adam', loss='mean_squared_error', **kwargs):
        super(NeuromindRegressor, self).__init__(model, optimizer, loss, **kwargs)
