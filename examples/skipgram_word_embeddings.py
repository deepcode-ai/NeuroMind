...
from neuromind.preprocessing import sequence, text
...
from neuromind.layers.embeddings import WordContextProduct, Embedding
...
train_model = True
save_dir = os.path.expanduser("~/.neuromind/models")
