...
from neuromind.layers.core import TimeDistributedDense, Activation
from neuromind.layers.recurrent import LSTM
from neuromind.optimizers import Adam
from neuromind.utils import generic_utils

from neuromind.layers.ntm import NeuralTuringMachine as NTM
