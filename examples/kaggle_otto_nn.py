...
from neuromind.layers.normalization import BatchNormalization
from neuromind.layers.advanced_activations import PReLU
...
'''
    ...
    on the Kaggle Otto challenge, with a deep net using Neuromind.
...
make_submission(proba, ids, encoder, fname='neuromind-otto.csv')
