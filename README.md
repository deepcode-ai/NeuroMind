...
Neuromind is compatible with __Python 2.7-3.4__.
...
```python
from neuromind.models import Sequential
from neuromind.layers.core import Dense, Dropout, Activation, Flatten
from neuromind.layers.convolutional import Convolution2D, MaxPooling2D
from neuromind.optimizers import SGD
...
```python
from neuromind.models import Sequential
from neuromind.layers.core import Dense, Dropout, Activation, Embedding
from neuromind.layers.recurrent import LSTM
...
Once you have the dependencies installed, cd to the Neuromind folder and run the install command:
```
