...
## Dense
```python
neuromind.layers.core.Dense(input_dim, output_dim, init='glorot_uniform', activation='linear', weights=None \
...
```python
neuromind.layers.core.TimeDistributedDense(input_dim, output_dim, init='glorot_uniform', activation='linear', weights=None \
W_regularizer=None, b_regularizer=None, W_constraint=None, b_constraint=None)
```
...
## Activation
```python
neuromind.layers.core.Activation(activation)
```
...
## Dropout
```python
neuromind.layers.core.Dropout(p)
```
...
## Reshape
```python
neuromind.layers.core.Reshape(*dims)
```
...
## RepeatVector
```python
neuromind.layers.core.RepeatVector(n)
```
